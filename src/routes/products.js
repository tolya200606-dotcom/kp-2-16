...
// Отримати продукти поточного користувача (потрібен токен)
// ВАЖЛИВО: цей маршрут має бути ДО "/:id", інакше "/user/my-products" зловиться як id="user".
...
router.post('/', authenticateToken, (req, res) => {
  try {
    ...
    const newProduct = productModel.create({
      ...
      inStock: Number.isFinite(qty) ? qty > 0 : false,
